...
def welcome(request):
    ...
    return render(request, 'all-templates/index.html', {"neighbourhoods": neighbourhoods, })
...
def new_business(request,pk):
    ...
    return render(request, 'all-templates/business.html', {"form": business_form,'neighborhood':neighborhood})
...
def hood_details(request,neighbourhood_id):
    ...
    return render(request,'all-templates/hood_details.html',{'neighbourhood':neighbourhood,'businesses':businesses,'posts':posts})
...
def new_post(request,pk):
    ...
    if request.method == 'POST':
        ...
        post_form = PostForm()
    return render(request, 'all-templates/post.html', {"form": post_form,'neighborhood':neighborhood})
